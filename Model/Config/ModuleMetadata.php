...
namespace AriyaInfoTech\DiscountLimit\Model\Config;
...
class ModuleMetadata implements ModuleMetadataInterface
{
    ...
    const PRODUCT_NAME  = 'Discount Limiter';

    const PRODUCT_URL = 'https://www.ariyainfotech.com/';

    const MODULE_NAME = 'AriyaInfoTech_DiscountLimit';

    const VERSION_CACHE_KEY = 'AriyaInfoTech-discountlimit-module-version';
